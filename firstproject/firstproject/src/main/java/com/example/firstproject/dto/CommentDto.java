...
public class CommentDto {
    ...
    public static CommentDto createCommentDto(Comment comment) { // 정적 메서드로 선언됨 -> 객체 생성 없이 호출 가능한 메서드라는 의미 (=생성 메서드)
        return new CommentDto( // 메서드의 반환값이 DTO가 되도록 CommentDto의 생성자를 호출
